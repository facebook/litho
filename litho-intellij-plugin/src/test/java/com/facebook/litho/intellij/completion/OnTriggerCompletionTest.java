...
public class OnTriggerCompletionTest extends LithoPluginIntellijTest {

  public OnTriggerCompletionTest() {
    super("testdata/completion");
  }

  @Test
  public void eventInLithoClass_completes() throws IOException {
    String clsName = "OnTriggerCompletionSpec.java";
    ...
    assertThat(lookupElements).contains("onTriggerEvent");
  }

  @Test
  public void eventNotInLithoClass_notCompletes() throws IOException {
    String clsName = "OnTriggerNotLithoCompletionTest.java";
  ...
  public void eventAboveMethod_completes() throws IOException {
    String clsName = "OnTriggerAboveMethodCompletionSpec.java";
