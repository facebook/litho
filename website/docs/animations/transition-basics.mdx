...
```java file=../../../sample/src/main/java/com/facebook/samples/litho/animations/docs/SimpleAllLayoutTransitionComponentSpec.java start=start end=no_animation
```
...
```java file=../../../sample/src/main/java/com/facebook/samples/litho/animations/docs/SimpleAllLayoutTransitionComponentSpec.java start=no_animation end=end
```
...
```java file=../../../sample/src/main/java/com/facebook/samples/litho/animations/docs/AlphaTransitionComponentSpec.java start=start end=end
```
...
private static final String SQUARE_KEY = "oval";
private static final String SQUARE_KEY = "another_shape";
