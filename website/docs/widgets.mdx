...
If your card is rendered on top of a dynamically colored background which cannot be "faked" using the `Card` component, check out the less performant [`TransparencyEnabledCard`](pathname:///javadoc/com/facebook/litho/widget/TransparencyEnabledCard.html).
