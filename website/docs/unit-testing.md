...
- [ComponentAssert](javadoc/com/facebook/litho/testing/assertj/ComponentAssert.html) for assertions that are run against either Component builders
  or Components.
- [LithoViewAssert](javadoc/com/facebook/litho/testing/assertj/LithoViewAssert.html) for assertions against mounted Components.

As a convenience, a [LithoAssertions.assertThat](javadoc/com/facebook/litho/testing/assertj/LithoAssertions.html) method is provided that
