...
inline class DslScope(val c: ComponentContext) {
  val context: ComponentContext get() = c
  val androidContext: Context get() = c.androidContext
  val resourceResolver: ResourceResolver get() = c.resourceResolver
