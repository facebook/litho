...
/**
 * Model that is an abstract representation of a method param that is an layout phase inter-stage
 * input.
 */
@Immutable
public class PrepareInterStageInputParamModel implements MethodParamModel {
  private final MethodParamModel mParamModel;

  PrepareInterStageInputParamModel(MethodParamModel paramModel) {
