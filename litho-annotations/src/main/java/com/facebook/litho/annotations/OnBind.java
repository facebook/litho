 ...
 *
 * <p>Methods annotated with {@link OnBind} take a {@code ComponentContext} as the first parameter,
 * the Object that the {@link MountSpec} mounts as the second parameter, followed by any number of
 * {@link Prop}s.
 *
