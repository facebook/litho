...
/**
 * Allows a top-down communicate with a component. The component must be able to handle {@link
 * com.facebook.litho.annotations.OnTrigger} events in order to accept an EventTrigger.
 */
