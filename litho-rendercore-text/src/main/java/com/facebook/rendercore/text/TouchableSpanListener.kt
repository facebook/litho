 ...
 * Using such objects within the spannable can cause memory leaks as spannables are cached in
 * [android.text.TextLine.sCached] which is static.
 */
fun interface TouchableSpanListener {
  /**
   ...
   */
  fun onTouch(span: ClickableSpan?, motionEvent: MotionEvent, view: View): Boolean
}
