...
/**
 * Mountable [CharSequence] that is aware when the Text component using this CharSequence is mounted
 * and unmounted.
 *
 * @see TextSpec
 */
interface MountableCharSequence : CharSequence {
  /**
