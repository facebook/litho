...
@GroupSectionSpec
object TreePropSectionTestParentGroupSpec {

  @JvmStatic
  @OnCreateTreeProp
  fun onCreateTreePropA(c: SectionContext, @Prop propA: TreePropNumberType): TreePropNumberType =
      propA

  @JvmStatic
  @OnCreateTreeProp
  fun onCreateTreePropB(c: SectionContext, @Prop propB: TreePropStringType): TreePropStringType =
      propB
  ...
  fun onCreateChildren(
      ...
      @Prop resultPropBLeaf2: TreePropSectionTestLeafGroupSpec.Result
  ): Children =
      Children.create()
          .child(
