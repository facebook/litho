...
@MountSpec
object MountSpecLifecycleTesterDrawableSpec {
  ...
  fun onCreateMountContentPool(): MountContentPool =
      TrackingMountContentPool("MountSpecLifecycleTester", 1, true)
  ...
  object StaticContainer {
    @SuppressLint("StaticFieldLeak") var sLastCreatedDrawable: ColorDrawable? = null
  }
}
