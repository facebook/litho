...
public class MountSpecPureRenderLifecycleTesterSpec {
  ...
  static boolean shouldUpdate(
      @Prop(optional = true) Diff<Boolean> shouldUpdate,
      @Prop Diff<LifecycleTracker> lifecycleTracker) {
    lifecycleTracker.getNext().addStep(LifecycleStep.SHOULD_UPDATE);
    if (shouldUpdate != null && shouldUpdate.getNext() != null) {
      return shouldUpdate.getNext();
    }
    return true;
  }
