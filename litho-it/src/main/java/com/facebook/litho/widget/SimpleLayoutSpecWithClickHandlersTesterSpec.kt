...
object SimpleLayoutSpecWithClickHandlersTesterSpec {
  ...
  fun onClickEvent(c: ComponentContext, @FromEvent view: View) = Unit

  @JvmStatic
  @OnEvent(LongClickEvent::class)
  fun onLongClickEvent(c: ComponentContext, @FromEvent view: View): Boolean = false
}
