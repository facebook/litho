...
@LayoutSpec
object LayoutSpecVisibilityEventTesterSpec {
  ...
  fun onTextVisible(c: ComponentContext, @Prop textOutput: Output<Any?>, @FromEvent content: Any?) {
    textOutput.set(content)
  }

  @JvmStatic
  @OnEvent(VisibleEvent::class)
  fun onViewVisible(c: ComponentContext, @Prop viewOutput: Output<Any?>, @FromEvent content: Any?) {
    viewOutput.set(content)
  }

  @JvmStatic
  @OnEvent(VisibleEvent::class)
  fun onNotAViewVisible(
      c: ComponentContext,
      @Prop nullOutput: Output<Any?>,
