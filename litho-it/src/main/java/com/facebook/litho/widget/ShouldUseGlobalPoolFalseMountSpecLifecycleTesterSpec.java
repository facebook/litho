...
public class ShouldUseGlobalPoolFalseMountSpecLifecycleTesterSpec {
  ...
  static MountContentPool onCreateMountContentPool() {
    return new TrackingMountContentPool("GlobalPoolMountSpecLifecycleTester", 1, true);
  }
  ...
  @ShouldUseGlobalPool
  static boolean shouldUseGlobalPool() {
    return false;
  }
}
