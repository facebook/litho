  ...
  fun testTypeIdForDifferentViewCreators() {
    ...
    val differentCompatComponent: ViewCompatComponent<*> =
        ViewCompatComponent.get(textViewCreator2, "differentCompat")
            ...
            .viewBinder(noOpViewBinder)
            .build()
    assertThat(compatComponent.instanceId).isNotEqualTo(sameCompatComponent.instanceId)
    assertThat(compatComponent.instanceId).isNotEqualTo(differentCompatComponent.instanceId)
    assertThat(sameCompatComponent.instanceId).isNotEqualTo(differentCompatComponent.instanceId)
