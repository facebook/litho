...
public class ComponentHostTest {
  ...
  @Test
  public void testTouchExpansionItem_shouldAddTouchDelegate() {
    View view = mock(View.class);
    when(view.getContext()).thenReturn(RuntimeEnvironment.application);
  ...
  @Test
  public void testRecursiveTouchExpansionItem_shouldNotAddTouchDelegate() {
  ...
  @Test
  public void testRecursiveTouchExpansionItemSecond_shouldNotCrash() {
    View view = mock(View.class);
    when(view.getContext()).thenReturn(RuntimeEnvironment.application);
