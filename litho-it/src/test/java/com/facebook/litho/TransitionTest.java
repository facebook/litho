...
public class TransitionTest {
  ...
  public void testCollectRootBoundsTransitionsExtractAppearFrom() {
    ...
    LayoutOutput rootLayout =
        new LayoutOutput(
            null, null, null, component, null, new Rect(0, 0, 300, 100), 0, 0, 0, 0, 0, 0, null);

    when(layoutState.getMountableOutputAt(0))
        .thenReturn(LayoutOutput.create(rootLayout, null, null, null, null));
  ...
  public void testCollectRootBoundsTransitionsExtractAppearFromDimensionValue() {
    ...
    when(layoutState.getAnimatableRootItem())
        .thenReturn(
            ((LithoRenderUnit)
                    LayoutOutput.create(rootLayout, null, null, null, null).getRenderUnit())
                .output);
