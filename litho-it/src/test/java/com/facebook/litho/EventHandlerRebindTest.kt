...
class EventHandlerRebindTest {
  ...
  fun `test section event handlers update even if row doesn't re-render`() {
    class RecordingButton(private val numRenders: AtomicInteger, private val textSize: Dimen) :
        KComponent() {
  ...
  private class RecordingClickListener : EventHandlerBindingSectionSpec.OnButtonClickListener {
