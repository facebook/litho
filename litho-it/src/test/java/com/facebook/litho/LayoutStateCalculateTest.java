...
public class LayoutStateCalculateTest {
  ...
  public void testNoMeasureOnNestedComponentWithSameSpecs() {
    ...
    final LithoLayoutResult internalNode =
        resolveStateContext.getCache().getCachedResult(innerComponent);
  ...
  public void testMeasure() {
    ...
    final LithoNode lithoNode = Resolver.resolveTree(resolveStateContext, c, component);
  ...
  public void testWillRenderLayoutsOnceInColumn() {
    ...
    verify(componentSpy, times(1))
        .render((ResolveStateContext) any(), (ComponentContext) any(), eq(0), eq(0));
  }
