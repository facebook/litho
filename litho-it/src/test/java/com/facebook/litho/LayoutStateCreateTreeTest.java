...
public class LayoutStateCreateTreeTest {
  ...
  public void simpleLayoutCreatesExpectedInternalNodeTree() {
    ...
    LithoNode node = Layout.resolve(mRenderStateContext, mComponentContext, component);
  ...
  public void testAddingAllAttributes() {
    ...
    final LithoNode node = Layout.resolve(mRenderStateContext, mComponentContext, component);
