    ...
    assertThat(moreExpensiveValue)
        .isEqualTo(
            "private java.lang.String getMoreExpensiveValue(com.facebook.litho.ComponentContext c) {\n"
                + "  String globalKey = c.getGlobalKey();\n"
                + "  final MoreExpensiveValueInputs inputs = new MoreExpensiveValueInputs(globalKey,arg0,getStateContainerImpl().arg1);\n"
                + "  java.lang.String moreExpensiveValue = (java.lang.String) c.getCachedValue(inputs);\n"
                + "  if (moreExpensiveValue == null) {\n"
                + "    moreExpensiveValue = CachedValueTestSpec.onCreateMoreExpensiveValue(arg0,getStateContainerImpl().arg1);\n"
    ...
    assertThat(moreExpensiveValueWithContext)
        .isEqualTo(
            "private java.lang.String getMoreExpensiveValueWithContext(com.facebook.litho.ComponentContext c) {\n"
                + "  String globalKey = c.getGlobalKey();\n"
                + "  final MoreExpensiveValueWithContextInputs inputs = new MoreExpensiveValueWithContextInputs(globalKey,arg0,getStateContainerImpl().arg1);\n"
                ...
                + "    moreExpensiveValueWithContext = CachedValueTestSpec.onCreateMoreExpensiveValueWithContext(arg0,getStateContainerImpl().arg1,c);\n"
