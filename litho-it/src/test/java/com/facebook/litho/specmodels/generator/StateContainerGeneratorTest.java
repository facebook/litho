    ...
    assertThat(StateContainerGenerator.generate(mSpecModelWithState, RunMode.normal()).toString())
        .isEqualTo(
            "@androidx.annotation.VisibleForTesting(\n"
                ...
                + "static class TestWithStateStateContainer<T extends java.lang.CharSequence>"
                + " extends com.facebook.litho.StateContainer {\n"
                ...
                + "\n"
                + "  @java.lang.Override\n"
                + "  public void applyStateUpdate(com.facebook.litho.StateContainer.StateUpdate"
                + " stateUpdate) {\n"
    ...
    assertThat(
        ...
        .isEqualTo(
            "@androidx.annotation.VisibleForTesting(\n"
                ...
                + ")\n"
                + "@com.facebook.litho.annotations.Generated\n"
                + "static class TestWithStateWithTransitionStateContainer<T extends"
                + " java.lang.CharSequence> extends com.facebook.litho.StateContainer implements"
                + " com.facebook.litho.SpecGeneratedComponent.TransitionContainer {\n"
                + "  @com.facebook.litho.annotations.State\n"
                + "  @com.facebook.litho.annotations.Comparable(\n"
                + "      type = 3\n"
                + "  )\n"
                ...
                + "      case 0:\n"
                + "        _transition ="
                + " TestWithStateWithTransitionSpec.testUpdateStateWithTransition();\n"
                + "        break;\n"
                + "\n"
                + "      case -2147483648:\n"
                + "        this.arg4 = (boolean) params[0];\n"
    ...
    assertThat(
        ...
        .isEqualTo(
            "@androidx.annotation.VisibleForTesting(\n"
                ...
                + ")\n"
                + "@com.facebook.litho.annotations.Generated\n"
                + "static class TestWithBothMethodsStateContainer<T extends java.lang.CharSequence>"
                + " extends com.facebook.litho.StateContainer implements"
                + " com.facebook.litho.SpecGeneratedComponent.TransitionContainer {\n"
                + "  @com.facebook.litho.annotations.State\n"
                + "  @com.facebook.litho.annotations.Comparable(\n"
                + "      type = 3\n"
    ...
    assertThat(
        ...
        .isEqualTo(
            "@androidx.annotation.VisibleForTesting(\n"
                ...
                + ")\n"
                + "@com.facebook.litho.annotations.Generated\n"
                + "static class TestWithSameGenericMultipleTimesStateContainer<T> extends"
                + " com.facebook.litho.StateContainer {\n"
                + "  @com.facebook.litho.annotations.State\n"
                + "  @com.facebook.litho.annotations.Comparable(\n"
                + "      type = 5\n"
                + "  )\n"
                ...
                + "        TestWithSameGenericMultipleTimesSpec.updateValues(values,"
                + " (java.util.List<T>) params[0]);\n"
    ...
    assertThat(
        ...
        .isEqualTo(
            "@androidx.annotation.VisibleForTesting(\n"
                ...
                + ")\n"
                + "@com.facebook.litho.annotations.Generated\n"
                + "static class TestWithMultipleGenericsStateContainer<T, E, D> extends"
                + " com.facebook.litho.StateContainer {\n"
                + "  @com.facebook.litho.annotations.State\n"
                + "  @com.facebook.litho.annotations.Comparable(\n"
                + "      type = 13\n"
                ...
                + "  public void applyStateUpdate(com.facebook.litho.StateContainer.StateUpdate"
                + " stateUpdate) {\n"
                + "    com.facebook.litho.StateValue<java.util.function.Function<E, D>>"
                + " functions;\n"
                + "\n"
                + "    final java.lang.Object[] params = stateUpdate.params;\n"
                + "    switch (stateUpdate.type) {\n"
                ...
                + "        TestWithMultipleGenericsSpec.updateValues(functions,"
                + " (java.util.function.Function<T, D>) params[0]);\n"
