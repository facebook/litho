...
/** Tests {@link ShouldUpdateValidation} */
public class ShouldUpdateValidationTest {
  ...
  public void testNoPropWithSameName() {
    ...
    List<SpecModelValidationError> validationErrors = ShouldUpdateValidation.validate(mSpecModel);
  ...
  public void testShouldUpdateParamTypeNotValid() {
    ...
    MethodParamModel methodParamModel3 =
        TestMethodParamModel.newBuilder()
            .type(
                ParameterizedTypeName.get(
                    ClassNames.DIFF, TypeVariableName.get("S"), TypeVariableName.get("T")))
            .name("name")
    ...
    MethodParamModel methodParamModel5 =
        TestMethodParamModel.newBuilder()
            .type(ParameterizedTypeName.get(ClassNames.DIFF, ClassName.get("java.lang", "Integer")))
            .name("name")
            .build();
