...
public class BuilderGeneratorTest {
  ...
  public void testGenerate() {
    ...
    assertThat(dataHolder.getMethodSpecs().get(1).toString())
        .isEqualTo(
            "public static Builder create(com.facebook.litho.ComponentContext context, int"
                + " defStyleAttr,\n"
                + "    int defStyleRes) {\n"
    ...
    assertThat(dataHolder.getTypeSpecs().get(0).toString())
        .isEqualTo(
            "@com.facebook.litho.annotations.Generated\n"
                ...
                + " com.facebook.litho.Component.Builder<Builder> {\n"
                + "  Test mTest;\n"
                + "\n"
                + "  com.facebook.litho.ComponentContext mContext;\n"
                + "\n"
                + "  private final java.lang.String[] REQUIRED_PROPS_NAMES = new String[]"
                + " {\"arg0\", \"section\"};\n"
                + "\n"
                + "  private final int REQUIRED_PROPS_COUNT = 2;\n"
                + "\n"
                + "  private final java.util.BitSet mRequired = new"
                + " java.util.BitSet(REQUIRED_PROPS_COUNT);\n"
                + "\n"
                + "  private Builder(com.facebook.litho.ComponentContext context, int defStyleAttr,"
                + " int defStyleRes,\n"
                + "      Test testRef) {\n"
                ...
                + "    mTest = (com.facebook.litho.specmodels.generator.BuilderGeneratorTest.Test)"
                + " component;\n"
                + "  }\n"
                + "\n"
                ...
                + "  )\n"
                + "  @com.facebook.litho.annotations.RequiredProp(\"section\")\n"
                + "  public Builder section(com.facebook.litho.sections.Section.Builder<?>"
                + " sectionBuilder) {\n"
                + "    this.mTest.section = sectionBuilder == null ? null :"
                ...
                + "\n"
                + "  @java.lang.Override\n"
                + "  public com.facebook.litho.specmodels.generator.BuilderGeneratorTest.Test"
                + " build() {\n"
    ...
    assertThat(dataHolder.getTypeSpecs().get(0).toString())
        .isEqualTo(
            "@com.facebook.litho.annotations.Generated\n"
                ...
                + "  @java.lang.Override\n"
                + "  protected void setComponent(com.facebook.litho.Component component) {\n"
                + "    mTestResTypeWithVarArgs ="
                + " (com.facebook.litho.specmodels.generator.BuilderGeneratorTest.TestResTypeWithVarArgs)"
                + " component;\n"
                + "  }\n"
                + "\n"
                + "  @com.facebook.litho.annotations.PropSetter(\n"
                ...
                + " {\n"
                + "      this.mTestResTypeWithVarArgs.sizes = new"
                ...
                + "      @androidx.annotation.Dimension(unit = androidx.annotation.Dimension.SP)"
                + " float sip) {\n"
                + "    if (this.mTestResTypeWithVarArgs.sizes == java.util.Collections.EMPTY_LIST)"
                + " {\n"
                + "      this.mTestResTypeWithVarArgs.sizes = new"
                ...
                + " java.util.ArrayList<java.lang.Float>();\n"
                + "    }\n"
                + "    final float res = mResourceResolver.resolveDimenSizeAttr(attrResId,"
                + " defResId);\n"
                + "    this.mTestResTypeWithVarArgs.sizes.add(res);\n"
                + "    return this;\n"
                + "  }\n"
                ...
                + "      final float res ="
                + " mResourceResolver.resolveDimenSizeAttr(attrResIds.get(i), defResId);\n"
                + "      this.mTestResTypeWithVarArgs.sizes.add(res);\n"
                + "    }\n"
                + "    return this;\n"
                + "  }\n"
                ...
                + "    for (int i = 0; i < attrResIds.size(); i++) {\n"
                + "      final float res ="
                + " mResourceResolver.resolveDimenSizeAttr(attrResIds.get(i), 0);\n"
                + "      this.mTestResTypeWithVarArgs.sizes.add(res);\n"
                + "    }\n"
                + "    return this;\n"
                + "  }\n"
    ...
    assertThat(dataHolder.getTypeSpecs().get(0).toString())
        .isEqualTo(
            "@com.facebook.litho.annotations.Generated\n"
                ...
                + " testDimenResTypeWithBoxFloatArgRef);\n"
                ...
                + "  @java.lang.Override\n"
                + "  protected void setComponent(com.facebook.litho.Component component) {\n"
                + "    mTestDimenResTypeWithBoxFloatArg ="
                + " (com.facebook.litho.specmodels.generator.BuilderGeneratorTest.TestDimenResTypeWithBoxFloatArg)"
                + " component;\n"
                + "  }\n"
                + "\n"
                + "  @com.facebook.litho.annotations.PropSetter(\n"
                ...
                + "      @androidx.annotation.Dimension(unit = androidx.annotation.Dimension.DP)"
                + " float dip) {\n"
                + "    this.mTestDimenResTypeWithBoxFloatArg.size = (float)"
                ...
                + "  public Builder sizeRes(@androidx.annotation.DimenRes int resId) {\n"
                + "    this.mTestDimenResTypeWithBoxFloatArg.size = (float)"
                + " mResourceResolver.resolveDimenSizeRes(resId);\n"
                + "    mRequired.set(0);\n"
                + "    return this;\n"
                + "  }\n"
                + "\n"
                ...
                + "      @androidx.annotation.DimenRes int defResId) {\n"
                + "    this.mTestDimenResTypeWithBoxFloatArg.size = (float)"
                + " mResourceResolver.resolveDimenSizeAttr(attrResId, defResId);\n"
                + "    mRequired.set(0);\n"
                + "    return this;\n"
                + "  }\n"
                + "\n"
                ...
                + "  public Builder sizeAttr(@androidx.annotation.AttrRes int attrResId) {\n"
                + "    this.mTestDimenResTypeWithBoxFloatArg.size = (float)"
                + " mResourceResolver.resolveDimenSizeAttr(attrResId, 0);\n"
                + "    mRequired.set(0);\n"
                + "    return this;\n"
                + "  }\n"
                + "\n"
    ...
    assertThat(dataHolder.getTypeSpecs().get(0).toString())
        .isEqualTo(
            "@com.facebook.litho.annotations.Generated\n"
                ...
                + "  @java.lang.Override\n"
                + "  protected void setComponent(com.facebook.litho.Component component) {\n"
                + "    mTestVarArgsWithDefaultValue ="
                + " (com.facebook.litho.specmodels.generator.BuilderGeneratorTest.TestVarArgsWithDefaultValue)"
                + " component;\n"
                + "  }\n"
                + "\n"
                + "  @com.facebook.litho.annotations.PropSetter(\n"
                ...
                + "      return this;\n"
                + "    }\n"
                + "    if (this.mTestVarArgsWithDefaultValue.list == null ||"
                + " this.mTestVarArgsWithDefaultValue.list == TestVarArgsWithDefaultValueSpec.list)"
                + " {\n"
                + "      this.mTestVarArgsWithDefaultValue.list = new"
                ...
                + "    }\n"
                + "    if (this.mTestVarArgsWithDefaultValue.list == null ||"
                + " this.mTestVarArgsWithDefaultValue.list.isEmpty() ||"
                + " this.mTestVarArgsWithDefaultValue.list == TestVarArgsWithDefaultValueSpec.list)"
                + " {\n"
    ...
    assertThat(dataHolder.getTypeSpecs().get(0).toString())
        .isEqualTo(
            "@com.facebook.litho.annotations.Generated\n"
                ...
                + "  protected void setComponent(com.facebook.litho.Component component) {\n"
                + "    mTestKotlinVarArg ="
                + " (com.facebook.litho.specmodels.generator.BuilderGeneratorTest.TestKotlinVarArg)"
                + " component;\n"
                + "  }\n"
                + "\n"
                + "  @com.facebook.litho.annotations.PropSetter(\n"
                ...
                + "      this.mTestKotlinVarArg.numbers = new"
