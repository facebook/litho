...
public class TriggerGeneratorTest {
    ...
    assertThat(TriggerGenerator.generateAcceptTriggerEventImpl(mSpecModel).toString())
        .isEqualTo(
            "@java.lang.Override\n"
                ...
                + "    final com.facebook.litho.EventTrigger eventTrigger, final java.lang.Object"
                + " eventState,\n"
                + "    final java.lang.Object[] params) {\n"
                + "  int id = eventTrigger.getId();\n"
                + "  switch(id) {\n"
                + "    case -773082596: {\n"
                + "      com.facebook.litho.specmodels.generator.TriggerGeneratorTest.TestEvent"
                + " _event ="
                + " (com.facebook.litho.specmodels.generator.TriggerGeneratorTest.TestEvent)"
                + " eventState;\n"
                + "      return testTriggerMethod1(\n"
                + "            (com.facebook.litho.ComponentContext)"
                + " eventTrigger.getComponentContext(),\n"
    ...
    assertThat(result)
        .isEqualTo(
            "private java.lang.Object testTriggerMethod1(com.facebook.litho.ComponentContext c,\n"
                ...
                + "    @androidx.annotation.Nullable T arg3, long arg4,"
  ...
  public void testGenerateStaticTriggerMethod() {
    ...
    assertThat(dataHolder.getMethodSpecs().get(0).toString())
        .isEqualTo(
            "/**\n"
                + " * This will send the testTriggerMethod1 trigger to the component with the given"
                + " handle.\n"
                + " * For more information about using triggers, see"
                + " https://fblitho.com/docs/trigger-events\n"
                + " */\n"
                + "public static <T extends java.lang.CharSequence> java.lang.Object"
                + " testTriggerMethod1(\n"
                + "    com.facebook.litho.ComponentContext c, com.facebook.litho.Handle handle,"
                + " java.lang.Object arg2,\n"
                + "    @androidx.annotation.Nullable T arg3, long arg4,"
                + " @androidx.annotation.Nullable T arg5) {\n"
                + "  int methodId = -773082596;\n"
                + "  com.facebook.litho.EventTrigger trigger = getEventTrigger(c, methodId,"
                + " handle);\n"
                + "  if (trigger == null) {\n"
                + "    return null;\n"
                + "  }\n"
    ...
    assertThat(dataHolder.getMethodSpecs().get(1).toString())
        .isEqualTo(
            "/**\n"
                + " * @deprecated Use {@link #testTriggerMethod1(ComponentContext, Handle)}"
                + " instead.\n"
                + " */\n"
    ...
    assertThat(dataHolder.getMethodSpecs().get(3).toString())
        .isEqualTo(
            "/**\n"
                ...
                + " */\n"
                + "@java.lang.Deprecated\n"
                + "static <T extends java.lang.CharSequence> java.lang.Object testTriggerMethod1(\n"
    ...
    assertThat(dataHolder.getMethodSpecs().get(4).toString())
        .isEqualTo(
            "/**\n"
                + " * This will send the testTriggerMethod2 trigger to the component with the given"
                + " handle.\n"
                + " * For more information about using triggers, see"
                + " https://fblitho.com/docs/trigger-events\n"
                + " */\n"
    ...
    assertThat(dataHolder.getMethodSpecs().get(5).toString())
        .isEqualTo(
            "/**\n"
                + " * @deprecated Use {@link #testTriggerMethod2(ComponentContext, Handle)}"
                + " instead.\n"
                + " */\n"
                + "@java.lang.Deprecated\n"
                + "public static void testTriggerMethod2(com.facebook.litho.ComponentContext c,"
  ...
  public void testGenerateStaticGetTriggerMethods() {
    ...
    assertThat(dataHolder.getMethodSpecs().get(0).toString())
        .isEqualTo(
            "private static"
                + " com.facebook.litho.EventTrigger<com.facebook.litho.specmodels.generator.TriggerGeneratorTest.TestEvent>"
                + " createTestTriggerMethod1Trigger(\n"
                + "    com.facebook.litho.ComponentContext c, com.facebook.litho.Component"
                + " component) {\n"
                + "  int methodId = -773082596;\n"
    ...
    assertThat(dataHolder.getMethodSpecs().get(1).toString())
        .isEqualTo(
            "/**\n"
                + " * @deprecated Do not use this method to get a EventTrigger to use later."
                + " Instead give the component a Handle and use {@link"
                + " #testTriggerMethod1(ComponentContext, Handle)}.\n"
                + " */\n"
                + "@java.lang.Deprecated\n"
                + "public static"
                + " com.facebook.litho.EventTrigger<com.facebook.litho.specmodels.generator.TriggerGeneratorTest.TestEvent>"
                + " testTriggerMethod1Trigger(\n"
                + "    com.facebook.litho.ComponentContext c, java.lang.String key) {\n"
                + "  int methodId = -773082596;\n"
    ...
    assertThat(dataHolder.getMethodSpecs().get(2).toString())
        .isEqualTo(
            "private static com.facebook.litho.EventTrigger<java.lang.Object>"
                + " createTestTriggerMethod2Trigger(\n"
                + "    com.facebook.litho.ComponentContext c, com.facebook.litho.Component"
                + " component) {\n"
                + "  int methodId = 969727739;\n"
                + "  return newEventTrigger(c, component, methodId);\n"
    ...
    assertThat(dataHolder.getMethodSpecs().get(3).toString())
        .isEqualTo(
            "/**\n"
                + " * @deprecated Do not use this method to get a EventTrigger to use later."
                + " Instead give the component a Handle and use {@link"
                + " #testTriggerMethod2(ComponentContext, Handle)}.\n"
                + " */\n"
                + "@java.lang.Deprecated\n"
                + "public static com.facebook.litho.EventTrigger<java.lang.Object>"
                + " testTriggerMethod2Trigger(\n"
                + "    com.facebook.litho.ComponentContext c, java.lang.String key) {\n"
                + "  int methodId = 969727739;\n"
                + "  return newEventTrigger(c, key, methodId);\n"
                + "}\n");
