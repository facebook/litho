...
final class FullGroupSection<T> extends Section {
  ...
  public boolean isEquivalentTo(Section other) {
    ...
    if (prop5 != null ? !prop5.isEquivalentTo(fullGroupSectionRef.prop5) : fullGroupSectionRef.prop5 != null) {
      return false;
    }
  ...
  protected void transferState(StateContainer _prevStateContainer,
    ...
    FullGroupSectionStateContainer<T> prevStateContainer = (FullGroupSectionStateContainer<T>) _prevStateContainer;
    FullGroupSectionStateContainer<T> nextStateContainer = (FullGroupSectionStateContainer<T>) _nextStateContainer;
    nextStateContainer.state1 = prevStateContainer.state1;
    nextStateContainer.state2 = prevStateContainer.state2;
  }

  private FullGroupSectionStateContainer getStateContainerWithLazyStateUpdatesApplied(SectionContext c,
      FullGroupSection component) {
  ...
  private void testEvent(HasEventDispatcher _abstract, SectionContext c, TextView view,
    ...
    FullGroupSectionStateContainer stateContainer = getStateContainerWithLazyStateUpdatesApplied(c, _ref);
  ...
  public static EventHandler<ClickEvent> testEvent(SectionContext c, int someParam) {
    return newEventHandler(FullGroupSection.class, "FullGroupSection", c, -1204074200, new Object[] {
          c,
          someParam,
        });
  }
  ...
  private String onCreateService(SectionContext c) {
    String _result;
    _result = (String) FullGroupSectionSpec.onCreateService(
      (SectionContext) c,
      (String) prop2);
    return _result;
  }
  ...
  protected Children createChildren(SectionContext c) {
    Children _result;
    _result = (Children) FullGroupSectionSpec.onCreateChildren(
      (SectionContext) c,
      (Component) prop3,
      (String) prop4,
      (Section) prop5,
  ...
  @Override
  protected boolean shouldUpdate(SectionContext _prevScopedContext, Section _prevAbstractImpl,
      SectionContext _nextScopedContext, Section _nextAbstractImpl) {
    ...
    _result = (boolean) FullGroupSectionSpec.shouldUpdate(
      (Diff<Integer>) prop1);
    return _result;
  }
  ...
  protected void dataRendered(SectionContext c, boolean isDataChanged, boolean isMounted,
      long uptimeMillis, int firstVisibleIndex, int lastVisibleIndex, ChangesInfo changesInfo,
      int globalOffset) {
  ...
  protected TreeProps getTreePropsForChildren(SectionContext c, TreeProps parentTreeProps) {
    ...
    childTreeProps.put(com.facebook.litho.sections.processor.integration.resources.FullGroupSectionSpec.TreePropWrapper.class, FullGroupSectionSpec.onCreateTreeProp(
        (SectionContext) c,
        useTreePropsFromContext() ? ((FullGroupSectionSpec.TreePropWrapper) Component.getTreePropFromParent(parentTreeProps,com.facebook.litho.sections.processor.integration.resources.FullGroupSectionSpec.TreePropWrapper.class)) : treeProp));
