...
public final class ChangeSet {
  ...
  /**
   * Used internally by the famework to merge all the ChangeSet generated by all the leaf
   * {@link Section}. The merged ChangeSet will be passed to the
   * {@link Target}.
   */
  static ChangeSet merge(
      ChangeSet first,
      ChangeSet second) {
