...
@LayoutSpec
class AppearDisappearCustomTransitionSpec {
  ...
  static void onClick(ComponentContext c) {
    AppearDisappearCustomTransition.updateState(c);
  }
  ...
  @OnCreateTransition
  static Transition onCreateTransition(ComponentContext c, @State boolean shouldShowItem) {
    final TransitionSet blueBoxAppearDisappearTransition = createBlueBoxAppearDisappearTransition();
    return shouldShowItem
        ? Transition.stagger(200, Transition.allLayout(), blueBoxAppearDisappearTransition)
        : Transition.stagger(200, blueBoxAppearDisappearTransition, Transition.allLayout());
  }

  private static TransitionSet createBlueBoxAppearDisappearTransition() {
    return Transition.parallel(
        Transition.create(Transition.TransitionKeyType.LOCAL, BLUE_BOX_TRANSITION_KEY)
