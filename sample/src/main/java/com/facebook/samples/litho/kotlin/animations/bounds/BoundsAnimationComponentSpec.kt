...
object BoundsAnimationComponentSpec {
  ...
  fun toggleABT(autoBoundsTransitionEnabled: StateValue<Boolean>) {
    val isEnabled = autoBoundsTransitionEnabled.get()
    isEnabled?.let { autoBoundsTransitionEnabled.set(!isEnabled) }
  }
  ...
  fun toggleFlag1(flag1: StateValue<Boolean>) {
    val flagValue = flag1.get()
    flagValue?.let { flag1.set(!flagValue) }
  }
  ...
  fun toggleFlag2(flag2: StateValue<Boolean>) {
    val flagValue = flag2.get()
    flagValue?.let { flag2.set(!flagValue) }
  }
  ...
  fun toggleFlag3(flag3: StateValue<Boolean>) {
    val flagValue = flag3.get()
    flagValue?.let { flag3.set(!flagValue) }
  }
  ...
  fun toggleFlag4(flag4: StateValue<Boolean>) {
    val flagValue = flag4.get()
    flagValue?.let { flag4.set(!flagValue) }
  }
