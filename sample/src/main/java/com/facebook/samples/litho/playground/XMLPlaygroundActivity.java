...
public class XMLPlaygroundActivity extends NavigatableDemoActivity {

  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);

    setContentView(R.layout.activity_xml_playground);

    LithoView lithoView = findViewById(R.id.litho_view);
    lithoView.setComponent(new PlaygroundKComponent());
  }
}
