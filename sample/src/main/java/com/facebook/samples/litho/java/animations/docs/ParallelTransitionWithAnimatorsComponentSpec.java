...
@LayoutSpec
public class ParallelTransitionWithAnimatorsComponentSpec {
            ...
            Row.create(c)
                ...
                .child(
                    SolidColor.create(c)
                        ...
                        .color(PURPLE_COLOR)))
        .clickHandler(ParallelTransitionWithAnimatorsComponent.onClickEvent(c))
  ...
  static void onClickEvent(ComponentContext c, @FromEvent View view) {
    ParallelTransitionWithAnimatorsComponent.onUpdateState(c);
  }
