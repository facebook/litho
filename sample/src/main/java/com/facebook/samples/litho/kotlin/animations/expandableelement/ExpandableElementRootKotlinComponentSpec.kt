...
@LayoutSpec
object ExpandableElementRootKotlinComponentSpec {
              ...
              Row.create(c)
                  ...
                  .child(
                      Text.create(c)
                          ...
                          .clickHandler(ExpandableElementRootKotlinComponent.onClick(c, true)))
                  .child(
                      Text.create(c)
                          .paddingDip(YogaEdge.ALL, 10f)
                          .text("DELETE")
                          ...
                          .alignSelf(YogaAlign.CENTER)
                          .alignment(TextAlignment.CENTER)
                          .clickHandler(ExpandableElementRootKotlinComponent.onClick(c, false))))
          .child(
              RecyclerCollectionComponent.create(c)
                  ...
                  .section(
                      DataDiffSection.create<Message>(SectionContext(c))
                          .data(messages)
                          .renderEventHandler(ExpandableElementRootKotlinComponent.onRender(c))
                          .build())
  ...
  fun onClick(c: ComponentContext, @Prop initialMessages: List<Message>, @Param adding: Boolean) {
    ExpandableElementRootKotlinComponent.onUpdateList(c, adding, initialMessages.size)
  }
    ...
    if (adding) {
      counterValue?.let {
        updatedMessageList.add(
            1, Message(true, "Just Added #$counterValue", true, "Recently", true))
