...
public class CustomVisibilityExtension extends MountExtension<VisibilityExtensionInput> {
    ...
    public CustomVisibilityExtension(Host host) {
        mHost = host;
    ...
    private void processVisibilityOutputsNonInc(@Nullable Rect localVisibleRect, boolean isDirty) {
        ...
        for (int j = 0, size = mVisibilityOutputs.size(); j < size; j++) {
            ...
            final boolean boundsIntersect = isHostVisible;
    ...
    @Override
    public void beforeMount(VisibilityExtensionInput input, @Nullable Rect localVisibleRect) {
