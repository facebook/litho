...
When defining transitions, you need to indicate to the framework what `Component`/`AnimatedProperty` pairs you want it to animate. Based on the presence of the Component in *before* and *after* states, we can define 3 types of transitions: [Change](#change-transitions), [Appear](#appear-transitions), and [Disappear](#disappear-transitions).
...
<video height="150" loop="true" autoplay="true" class="video" width="100%" height="500px">
