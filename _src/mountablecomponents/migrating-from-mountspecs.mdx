...
:::note
For MountSpecs that did not implement @OnMeasure or @OnBoundsDefined at all, `Mountable.measure()` can leverage [MeasureResult.withEqualDimensions()](https://fburl.com/measureresultwithequaldimensions) method to set return the appropriate sizes.
:::
