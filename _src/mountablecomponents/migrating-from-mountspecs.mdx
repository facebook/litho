...
More information on mounting and unmounting content properties can be found on the [Lifecycle of a SimpleMountable](mountable.mdx/#mounting-and-unmounting-content-properties) page.
