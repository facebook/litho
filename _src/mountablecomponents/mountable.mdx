...
`MountableComponent.render()` method should return a `Mountable` implementation and any `Style` object you want to apply to the component on the `MountableRenderResult` object.
