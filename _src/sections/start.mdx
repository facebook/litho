...
This is all you need to know about adding Sections to your layout for now. You can find an explanation of advanced use cases such as snapping and horizontal lists on the [RecyclerCollectionComponent docs](recycler-collection-component.md).
...
:::tip
You can visit the [Best Practices and Performance](best-practices.mdx) documentation for a deep dive of how to build performant and accurate diffing, including diffing for classes where `equals` is not overwritten.
:::
...
We suggest reading into [Best Practices and Performance](best-practices.mdx) first. Afterwards you can head for one of the documents referring to advanced use cases your list may have, such as [complex list layouts](recycler-collection-component.md), [granular dependency injection](services.md), or [prefetch and pagination](working-ranges.md).
