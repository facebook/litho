...
:::caution
This page covers the older Java codegen-based Sections API. If you're using the Kotlin Lazy Collection API, refer to the [performance docs for Lazy Collection](../kotlin/lazycollections/lazycollections-working-with-updates.mdx).
:::
