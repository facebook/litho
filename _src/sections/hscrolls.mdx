...
To see how to create a horizontally scrolling list using a `RecyclerCollectionComponent`, check out [this](recycler-collection-component#horizontal-lists) guide.
