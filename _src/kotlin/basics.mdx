...
:::note
**This page covers how to convert existing Component with `@LayoutSpecs` to Kotlin `KComponent`.** Please refer to this **[page](tutorial/first-components.md)** for the main Components and Props docs.
:::
