...
For new development, the [Primitive Components](mainconcepts/primitivecomponents/overview.mdx) is a recommended way to migrate from custom Views to Litho Components.
:::
