...
As in the Spec API, `Row` and `Column` are the primary layout containers used in the KComponent API. If you need a refresher on them, check out the main [layout docs](/docs/mainconcepts/flexbox-yoga).
