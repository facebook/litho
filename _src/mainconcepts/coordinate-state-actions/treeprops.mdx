...
A TreeProp is a special type of [prop](/docs/mainconcepts/passing-data-to-components/props), which is transparently passed
...
If you want to access a TreeProp from the component that created this TreeProp, you can transform it into [`@State`](/docs/mainconcepts/coordinate-state-actions/state-overview) value like this:
