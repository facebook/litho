...
Internally, Litho achieves this by leveraging the lifecycle of the `Choreographer` API and how it breaks down its different work phases. Whenever the `Choreographer` receives a VSYNC signal,
