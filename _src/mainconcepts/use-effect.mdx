...
[^1]: Side effects include operations such as fetch requests, subscriptions, using timers, and manually changing the DOM. By using the useEffect hook, you are stating that the component needs to do someting after its rendered.
