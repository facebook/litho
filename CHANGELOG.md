 ...
 * **Breaking:** Remove `checkNeedsRemeasure`, `useVisibilityExtension`, `useInternalNodesForLayoutDiffing`, `ignoreDuplicateTransitionKeysInLayout`, `computeRangeOnSyncLayout` and `threadPoolForBackgroundThreadsConfig` configuration parameters from `ComponentsConfiguration`.
