 ...
 * **Breaking:** Remove `checkNeedsRemeasure`, `useVisibilityExtension`, `useInternalNodesForLayoutDiffing`, `computeRangeOnSyncLayout` and `threadPoolForBackgroundThreadsConfig` configuration parameters from `ComponentsConfiguration`.
