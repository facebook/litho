...
class EditorArray : EditorValue {
  @JvmField val value: List<EditorValue>

  constructor(value: List<EditorValue>) {
    this.value = value
  }

  constructor(vararg values: EditorValue) {
    this.value = listOf(*values)
  }
