...
:::note
**This page covers how to convert existing code from lifecycle methods in the Java Specs API to hooks in the Kotlin API.** Please refer to this **[page](mainconcepts/hooks-intro.mdx)** for the main Hooks docs.
:::
