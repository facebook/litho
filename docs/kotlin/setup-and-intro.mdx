...
* If you just want a reference comparing features in the Spec API to their equivalents in Kotlin, then you'll find the [Cheatsheet](cheatsheet-primitives.mdx) useful.
