...
:::note
This page covers how to convert existing Component with `@LayoutSpecs` to Kotlin `KComponent`.
For information regarding the main Components and Props, refer the [Components and Props Tutorial](../tutorial/first-components.md).
:::

## Basics

The most fundamental change in the Litho Kotlin API is that code generation is no longer used. This means you don't need to mark your Components as `@LayoutSpecs` or declare any other annotations in the class. Remember to leave off the 'Spec' at the end of the Component name as well!
