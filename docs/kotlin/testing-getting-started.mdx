...
```kotlin file=litho-core/src/test/kotlin/com/facebook/litho/examples/LithoViewRuleExampleTest.kt start=start_example end=end_example
```
...
```kotlin file=litho-core/src/test/kotlin/com/facebook/litho/examples/LithoViewRuleExampleTest.kt start=start_render_example end=end_render_example
```
