...
```kotlin file=litho-it/src/test/com/facebook/litho/examples/LithoTestRuleExampleTest.kt start=start_example end=end_example
```
...
```kotlin file=litho-it/src/test/com/facebook/litho/examples/LithoTestRuleExampleTest.kt start=start_render_example end=end_render_example
```
