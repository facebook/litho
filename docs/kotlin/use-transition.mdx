...
The `useTransition` hook corresponds to the Java Spec API's `@OnCreateTransition` functionality. If you haven't already, make sure to review the [Hooks Intro](hooks-intro.mdx) docs to understand more about hooks.
