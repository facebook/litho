...
`LithoViewRule.render(Component)` returns a `LithoView`, which can be used for assertions that can be found in the [LithoViewAssert](https://staticdocs.thefacebook.com/litho/javadoc/com/facebook/litho/testing/assertj/LithoViewAssert.html) class.
