...
```kotlin file=sample/src/main/java/com/facebook/samples/litho/kotlin/mountables/SimpleImageViewComponent.kt start=start_preallocation_example end=end_preallocation_example
```

For the SimpleImageViewComponent example above, ten instances of ImageView will be created and pre-allocated in the recycling pool.
