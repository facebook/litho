...
Accessibility properties and events for Mountable Components can be implemented by adding them to Style object that will be returned on MountableWithStyle object from render() method.

You can see an example of how to combine Style that was passed to Mountable Component with a newly created Style object that implements accessibility properties and events:
...
The following list provides the supported properties on Style object:
...
The following table provides the supported events on Style object:
