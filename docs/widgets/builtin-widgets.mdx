...
This page covers the basic built-in widgets. You can find the full list of components and APIs within the [com.facebook.litho.widget](pathname:///javadoc/index.html?com/facebook/litho/widget/package-summary.html) package in javadocs.
...
If you  want to use `Recycler` directly, see the [Adding and adapting the RecyclerCollection to your app](../sections/recycler-collection-component.md) page.
