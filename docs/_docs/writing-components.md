...
The only API exposed by the generated class is a `create(...)` method that returns the appropriate [`Component.Builder`](linktojavadoc) for the `@Prop`s that you declared in your spec class.
