...
:::note
In the above example, the returned `LithoPrimitive` object includes `a11y`. This is a reference to the [A11Y Project](https://www.a11yproject.com/), which A11Y describes as a "*a community-driven effort to make digital accessibility easier.*"
:::
