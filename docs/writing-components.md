...
A few things to note:
 ...
 - For components to be created from your component specs, you need to add the Litho annotation processor to your BUCK or Gradle file. See the [Getting Started](getting-started.mdx) guide on how to do that. You can make the generated class package-private by adding `isPublic = false` to the class annotation.
...
The generated `ComponentLifecycle` class is what you are going to [use in your product](using-components.md). The spec class will be used as a delegate in the generated code at runtime.
