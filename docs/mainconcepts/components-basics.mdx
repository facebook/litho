...
If you need to integrate your own views/drawables with Litho, please see [Primitive Components](../../mainconcepts/primitivecomponents/overview/)
...
- **[Tree Props](/mainconcepts/treeprops.mdx)** - provides a way to give access to contextual objects, like a theme or logging utility, to all components in a sub-tree without having to manually pass them.
