...
```java file=sample/src/main/java/com/facebook/samples/litho/java/lifecycle/LifecycleDelegateActivity.java start=start_example_lifecycleprovider end=end_example_lifecycleprovider
```
...
```java file=sample/src/main/java/com/facebook/samples/litho/java/lifecycle/ScreenSlidePageFragment.java start=start_example_lifecycleprovider end=end_example_lifecycleprovider
```

#### Fragment Transaction example

```java file=sample/src/main/java/com/facebook/samples/litho/java/lifecycle/LifecycleFragment.java start=start_example_lifecycleprovider end=end_example_lifecycleprovider
```
