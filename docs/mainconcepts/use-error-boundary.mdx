...
The code sample below shows how a component can handle an error in one of its child components and render an error state instead of crashing the app:
...
The following example shows the use of try/catch:
...
This is the responsibility of the Litho framework, hence the need to provide higher-level infrastructure to give you access to those errors.
