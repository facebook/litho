...
Primitive should provide an implementation of [LayoutBehavior](https://github.com/facebook/litho/blob/75655943f348c0347d534e6931fb53b2f7f16195/litho-rendercore-primitives/src/main/java/com/facebook/rendercore/primitives/LayoutBehavior.kt#L30) interface to define how it should measure itself, based on the provided SizeConstraints.
