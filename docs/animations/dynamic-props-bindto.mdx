...
```
```kotlin file=sample/src/main/java/com/facebook/samples/litho/kotlin/primitives/bindto/ImageViewPrimitiveComponent.kt start=start_bindTo_imagecomponent_code end=end_bindTo_imagecomponent_code
```
...
```kotlin file=sample/src/main/java/com/facebook/samples/litho/kotlin/primitives/bindto/ImageViewPrimitiveComponent.kt start=start_bindTo_binding_code end=end_bindTo_binding_code
```
