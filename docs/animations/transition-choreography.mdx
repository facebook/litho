...
A Listener can be added to receive a callback when an individual transition has ended. This is done through Litho event dispatcher methods (see [Events Overview](../mainconcepts/coordinate-state-actions/events.md).
