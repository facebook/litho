...
:::tip
Checkout the [**sub-component testing**](subcomponent-testing.mdx) section before diving into
prop matching.
:::

In this article, we will drill a bit deeper and explore TestSpecs as a way to test individual
props of those components, even if we don't know all of them.
