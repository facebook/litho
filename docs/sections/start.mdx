...
:::info
The Sections API (see the 'API' menu) is built on top of Litho. It provides a declarative, composable, and thread-safe API for writing highly optimised List screens.
:::

## Introduction

The Sections API tries to address issues experienced at Meta when writing complex Lists, such as maintaining many view types, handling multiple data sources, and composing Lists together.
