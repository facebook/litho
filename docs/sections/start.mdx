...
The Sections API addresses issues experienced when writing complex Lists, such as maintaining many view types, handling multiple data sources, and composing Lists together.
