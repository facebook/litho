...
:::caution
This page covers the old Java Spec API. If you aren't using the Spec API, refer to the [TreeProps](../../mainconcepts/props.mdx#tree-props) section of the 'Types of Props' page.
:::
...
If you want to access a TreeProp from the component that created it, you can transform it into [State](../state-for-specs.md) as follows:
