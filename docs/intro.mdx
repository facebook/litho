...
functional API based on Java annotations. It was [primarily built](uses.md)
...
thread](asynchronous-layout.md), automatically [flattening your view
hierarchy](view-flattening.md), and [incrementally
rendering](./deep-dive/incremental-mount.md) complex components.
...
Have a look at our [Tutorial](tutorial.mdx) for a step-by-step guide on using
Litho in your app. You can also read the quick start guide on how to
[write](writing-components.md) and [use](using-components.md) your own
Litho components.
