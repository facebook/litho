...
public class BestEffortFrontOfQueueAndChoreographerBatchedUpdateStateTestRunConfiguration
  ...
  public void beforeTest(FrameworkMethod method) {
    ComponentsConfiguration.sBatchedUpdatesConfiguration =
        BatchedUpdatesConfiguration.BEST_EFFORT_FRONT_AND_CHOREOGRAPHER;
  }
