...
import com.facebook.components.annotations.GetExtraAccessibilityNodeAt;
import com.facebook.components.annotations.GetExtraAccessibilityNodesCount;
...
import com.facebook.components.annotations.OnMeasureBaseline;
import com.facebook.components.annotations.OnMount;
import com.facebook.components.annotations.OnPopulateAccessibilityNode;
import com.facebook.components.annotations.OnPopulateExtraAccessibilityNode;
...
public class MountSpecHelper extends ComponentSpecHelper {
   ...
   * {@link com.facebook.components.annotations.OnPopulateAccessibilityNode}-annotated method.
   */
  public void generateAccessibilityMethods() {
    final ExecutableElement onPopulateAccessibilityNode =
        Utils.getAnnotatedMethod(
            mStages.getSourceElement(),
            OnPopulateAccessibilityNode.class);

    final ExecutableElement onPopulateExtraAccessibilityNode =
        Utils.getAnnotatedMethod(
            mStages.getSourceElement(),
            OnPopulateExtraAccessibilityNode.class);
    ...
    if (onPopulateExtraAccessibilityNode != null) {
      ...
      generateGetExtraAccessibilityNodeAt(getExtraAccessibilityNodeAt);
      generateGetNumExtraAccessibilityNodes(getNumExtraAccessibilityNodes);
      generateImplementsExtraAccessibilityNodes();
    }
  ...
  private void generateOnPopulateAccessibilityNode(ExecutableElement onPopulateAccessibilityNode) {
    ...
    final TypeName returnType = ClassName.get(onPopulateAccessibilityNode.getReturnType());
  ...
  private void generateOnPopulateExtraAccessibilityNode(
      ExecutableElement onPopulateExtraAccessibilityNode) {
    final MethodDescription methodDescription = new MethodDescription();
    methodDescription.annotations = new Class[] { Override.class };
    methodDescription.accessType = Modifier.PROTECTED;
    methodDescription.name = "onPopulateExtraAccessibilityNode";
    methodDescription.returnType = ClassName.VOID;
    methodDescription.parameterTypes = new TypeName[] {
  ...
  private void generateGetExtraAccessibilityNodeAt(ExecutableElement getExtraAccessibilityNodeAt) {
    ...
    final TypeName returnType = ClassName.get(getExtraAccessibilityNodeAt.getReturnType());
