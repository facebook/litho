...
public interface ClassNames {
  ...
  ClassName LAYOUT_SPEC = ClassName.bestGuess("com.facebook.components.annotations.LayoutSpec");
  ClassName MOUNT_SPEC = ClassName.bestGuess("com.facebook.components.annotations.MountSpec");
  ClassName REFERENCE_SPEC =
      ClassName.bestGuess("com.facebook.components.annotations.ReferenceSpec");
