...
public class SizeSpec {
   ...
   * <ul>
   *  <li>{@link com.facebook.components.SizeSpec#UNSPECIFIED}</li>
   *  <li>{@link com.facebook.components.SizeSpec#EXACTLY}</li>
   * </ul>
   *
   ...
   * @return {@link com.facebook.components.SizeSpec#UNSPECIFIED} or
   *         {@link com.facebook.components.SizeSpec#EXACTLY}
   */
